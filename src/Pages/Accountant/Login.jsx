...
import LoginImg from "../../images/accountant/Login.svg"
    ...
    return (
        <>
            <Layout img={ LoginImg }>
                ...
                <input type="text" className={ style } placeholder='Enter your name or email' />
                <input type="text" className={ style } placeholder='Enter your password' />


                <p className='text-slate-green text-sm text-right'>Forgot password?</p>
